 ...
 * ■ データベースに接続するプログラム
 *
 * カリキュラム「JDBCドライバ」を参考に JDBCドライブのjarファイルの設置とビルドパスの追加も忘れないようにしましょう。
 *
 * 問①〜問④までを回答し、データベースと接続してみましょう。 カリキュラム「データベースを扱うための準備」を参考にしてください。
 *
 * 実行結果の提出に関しては、 いつも通りソースのコミットしていただきますが、 今回は実行結果のスクリーンショットも合わせて提出していただきます。
